...
MODEL_PATH = "outputs/task4_rlhf_transformer.pth"
...
def generate_samples():
    ...
    print("Generating Task 4 RLHF-tuned MIDI samples...")
    ...
    for i in range(NUM_SAMPLES):
        ...
        output_path = os.path.join(
            OUTPUT_DIR,
            f"task4_rlhf_generated_{i + 1}.mid"
        )
    ...
    print("Task 4 RLHF generation complete.")
